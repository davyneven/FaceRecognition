...
Mat getPreprocessedFace(Mat &srcImg, int desiredFaceWidth, dlib::frontal_face_detector &faceDetector,  dlib::shape_predictor &shapePredictor,bool doLeftAndRightSeparately, Rect *storeFaceRect = NULL, Point *storeLeftEye = NULL, Point *storeRightEye = NULL);
